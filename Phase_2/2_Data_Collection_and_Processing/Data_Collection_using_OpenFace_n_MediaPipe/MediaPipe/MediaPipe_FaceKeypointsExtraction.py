...
#------------------------------------------------------------------------------------    
def save_label_data(class_num, sample_coordinates_data, save_coord_as):  # sample_audio, save_coord_as, save_audio_as):
...
def train_data_preparation(video_data_dir="../../../data/original_data/Video_chunks/Video_chunks",
                           csv_path="../../../data/original_data/Video_chunks/Labels.xlsx",
                           class_to_num = {"truth": 0, "lie": 1},
                           num_to_class = {0: "truth", 1: "lie"},
                           save_keypoints_npy_to="../../../data/visual_features/mediaPipe_keypoints_data_UPD"):
